...
class UserAccounts extends Component {
  constructor(props) {
    ...
    this.loadUserAccounts = this.loadUserAccounts.bind(this);
  ...
  componentDidMount() {
    ...
    fetch('/api/user/accoutsCount').then(res => res.json())
      .then(json => {
        if (json.success) {
          this.setState({
    ...
    this.loadUserAccounts(activePage);
  }

  loadUserAccounts(activePage) {
    const { searchData, pageLimit,sortKey, sortOrder } = this.state;
    fetch('/api/user/accouts', {
      method: 'POST',
  ...
  handlePageChange(pageNumber) {
    ...
    this.loadUserAccounts(pageNumber);
  }
  ...
  exportUserData(e) {
    ...
    fetch('/api/user/exportusers').then(res => res.json())
      .then(json => {
        if (json.success) {
      ...
      if (norecords) {
        ...
        accountList = arr.map(function (accounts, index) {
          ...
          return <tr>
            ...
            <td>{index + sNo}</td>
            <td>{accounts.name} {accounts.last_name}({accounts.username})

            <FormHelperText className="usr-info-text">ID (EPI Code): {accounts.epiCode}</FormHelperText></td>
            ...
            <Link data-tip='Edit' to={`/user/manager/${id}`} className="btn action-btn-common btn-edit">&nbsp;</Link>&nbsp;
                ...
                <div className="container-fluid">
                  <div className="brd-srch-links">
                    <ul className="bread-crumb">
                      ...
                      <li><a className="active">User Account List</a></li>
                    </ul>
                    <div className="add-link">
                      ...
                      <Button data-tip='Add New account' mini component={Link} to="/user/manager" variant="contained" color="primary" aria-label="Add">
                        <AddIcon />
                      </Button>&nbsp;

                      <ReactTooltip />
                      <div className="frm-action-btns">
                        <button type="button" onClick={thisObj.exportUserData} className="btn btn-ac-cmn">Export CSV <i className="fa fa-share"></i></button>
                      </div>&nbsp;&nbsp;
                            ...
                            <div className="form-group search-box">
                              ...
                              <FormControl fullWidth>
                                ...
                                >
                                  ...
                                  <MenuItem value="epiCode">EPI Code</MenuItem>
