...
class submenuManager extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pageTitle: ' Menu Manager',
      pageSubTitle: ' Manage Sub Menu',
      arrayList: '',
      isLoading: false,
      logout: false,
      checked: true,
  ...
  loadSubMenus() {
    ...
    fetch('/api/menumanger/allsubmenuslist', {
      method: 'POST',
  ...
  render() {
    const { logout, formData, error, pageTitle, redirectPage, menuid
    } = this.state;
    let passContent = '';
    if (redirectPage) {
      return (
                ...
                <div className="container-fluid">
                  <div className="brd-srch-links">
                    <ul className="bread-crumb">
                      ...
                      <li><NavLink to={`/sub-menus/${menuid}`}>Sub Menu List</NavLink></li>
                      <li><a className="active">Manage Sub Menu </a></li>
