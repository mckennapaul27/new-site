...
class Login extends Component {
  ...
  componentDidMount() {
    ...
    console.log('db',isDev ? config.db_dev : config.db);
  ...
  _formValidation(fieldsToValidate = [], callback = () => { }) {
    ...
    console.log('captchaWord', captchaWord);
  ...
  _onSubmit(event) {
    ...
    let fieldNeedToValidate = ['username', 'password', 'captcha'];
        ...
        fetch('/api/account/signin',
          ...
          .then(json => {
            ...
            if (json.success) {
              ...
              setInStorage('coupon_login_id', { token: json.login_id });
              this.setState({
                    ...
                    <form onSubmit={this._onSubmit}>
                      ...
                      <div className="form-group">
                        ...
                        <FormControl fullWidth error={_.get(error, 'password')} aria-describedby="password-error-text" >
                          ...
                          <Input type="password" id="password-id" name="password" value={loginData.password} onKeyUp={this._onTextFieldBlur} onBlur={this._onTextFieldBlur} onChange={this._onTextFieldChange} />
                      ...
                      <div className="text-center">
                        <button className="btn btn-login" disabled={!diableBtn}>Login</button>
                        <Link className="frgt-pswrd" to="/forgot-password">Forgot Password?</Link>
                      </div>
                    </form>
                  </div>
                </div>
