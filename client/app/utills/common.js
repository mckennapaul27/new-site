    ...
    const ADMINMODULES = [
        {
            ...
            'icon': 'fa-user-cog',
            'submodules': [
                { 'name': 'My Account', 'url': '/my-account', 'id': 'my-account' },
                { 'name': 'Admin Account List', 'url': '/admin-accounts','id': 'admin-accounts' }
            ]
        },
        {
            'name': 'user_accounts',
            ...
            'submodules': [
                { 'name': 'Add New User', 'url': '/user/manager','id': 'admin-accounts1' },
                { 'name': 'User Accounts List', 'url': '/user-accounts','id': 'admin-accounts2' },
...

        {
            ...
            'icon': 'fa-folder',
            'submodules': [
                { 'name': 'Add New Menu', 'url': '/menu-manager' ,'id': 'admin-accounts7'},
